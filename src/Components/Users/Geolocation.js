...
console.log(rows)
  return (
    ...
    <>
      ...
      <br />
      <div style={{  display: "flex", justifyContent: "flex-start", width: "fit-content", flexDirection:"column" }}>
              ...
              {rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                .map((row, index) => (
                  <StyledTableRow key={index}>
                    ...
                    <StyledTableCell align="center">{row?.country || "NA"}</StyledTableCell>
                    <StyledTableCell align="center">{row?.zipcode || "NA"}</StyledTableCell>
