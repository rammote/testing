...
function AssignUser() {
  ...
  const handleUserAssign = (e, user) => {
    ...
    Server.get(
      `/user/assign?accountId=${user.accountid}&userId=${user.userid}&appId=${location.state.row.appid}&requestTime=${requestTime}`,
      {
        headers: {
        ...
        {/* <div style={{ paddingTop: '80px' }}>
          ...
          <div style={{ display: "flex", justifyContent: "flex-start" }}>
            ...
            <div style={{ display: "grid", width: 250 }}>
              ...
              >
                {location.state.row.appname} ({location.state.row.appid})
              </span>
              <span
                style={{
                  margin: 0,
          ...
          >
            <TextField
              ...
              name="search"
              id="outlined-basic"
              label="Search user using  phone number or email address"
              value={searchText}
